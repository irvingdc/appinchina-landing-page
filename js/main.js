...
function createAllCharts(){
	createChart("chartA", [54.3, 46.7], ["Users (54.3%)", "Non-Users (45.7%)"])
    createChart("chartB", [54, 44.06, 1.94], ["Mobile Phones (54%)", "Desktop (44.06%)", "Tablet (1.94%)"])
    createChart("chartC", [78.35, 20.71, 0.94], ["Android (78.35%)", "iOS (20.71%)", "Other (0.94%)"])
    chartsCreated = true
}
